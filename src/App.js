...
function App() {
  ...
  const handleGeneratePassword = (e) => {
    ...
    if (!includeUppercase && !includeLowercase && !includeNumbers && !includeSymbols) {
      notify('You Must Select atlest one option!', true)
    }
      ...
      <div className="container">
        <div className="generator">
          ...
          <div className="form-group">
            ...
            <input defaultValue={passwordLength} onChange={(e) => setPasswordLength(e.target.value)} type="number" id="password-strength" name="password-strength" max="25" min="7" />
          </div>
